token: str = "NzY0Mjc1MzUxOTA3NzI5NDIw.X4D44w.17f6QgsI2_jvJzxI_f38GA_W4iM"
...
ADD_MESSAGE_1 = """```To add this musicbot to your own Server, click the following link:
                ```\n<https://discordapp.com/oauth2/authorize?client_id="""
ADD_MESSAGE_2 = "&scope=musicbot>"
...
HELP_ADDBOT_LONG = "Gives you the link for adding this musicbot to another server of yours."
HELP_CC_SHORT = "Change voicechannel"
HELP_CC_LONG = "Switches the musicbot to another voicechannel."
HELP_CONNECT_SHORT = "Connect musicbot to voicechannel"
HELP_CONNECT_LONG = ""
HELP_DISCONNECT_SHORT = "Connect musicbot from voicechannel"
...
HELP_SPOTIFY_LONG = ("Gives you an easy way to share a song from Spotify via the musicbot.\n\n"
                     "!!!Spotify needs to be linked to your Discord account for this to work.!!!\n"
                     "The command takes the song that is being played by your Spotify client and plays it on the musicbot via Youtube.\n"
                     "You can target another users client by specifying his nickname as an argument.\n\n"
                     "The song needs to be playing for the command to launch, so you need to listen for the first few seconds of the song while the musicbot loads it up.\n"
                     "If the player is already playing, the command adds the song to the playingqueue.\n\n"
                     "(The musicbot is not 100% accurate and plays slightly different versions of the songs every now and then.)")
...
HELP_YT_LONG = ("Plays the audio of a Youtube video. Argument can either be:\n"
                ...
                "  - Keywords for a search(lofi hip-hop) -> the musicbot plays the first result)\n"
                "  - A link to a playlist -> the musicbot will play the songs one after another\n"
                "If the player is already playing, the command adds the song to the playingqueue")
